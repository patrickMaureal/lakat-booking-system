<x-app-layout>
	...
	{{-- modal --}}
	<x-modal modal-id="customer-modal" button-id="destroy-customer" type="delete" label="Customer" />

	@push('scripts')
		<script type="text/javascript" src="{{ asset('js/admin/page/customer/index.js') }}"></script>
	@endpush
