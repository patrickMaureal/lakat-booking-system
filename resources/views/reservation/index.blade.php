<x-app-layout>
	...
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
		<div class="d-block mb-md-0">
			<h2 class="h4">List of Reservation</h2>
		</div>
		...
		<table class="table table-hover">
			<thead>
				<tr>
					...
					<th class="border-gray-200">Guest</th>
					<th class="border-gray-200">Transaction Date</th>
					<th class="border-gray-200">Confirmation Code</th>
					<th class="border-gray-200">Total Accomodation</th>
