					...
					<div class="row">
						...
						<div class="col-md-6 mb-3">
							<div class="form-group">
								...
								<input class="form-control @error('username') is-invalid @enderror" id="username" name="username" type="text" placeholder="Username" value="{{ old('username', $user->username) }}" required>
								@error('username')
									<div class="invalid-feedback">
										{{ $message }}
									</div>
						...
						<div class="col-md-6 mb-3">
							<div class="form-group">
								...
								<select class="form-select @error('role') is-invalid @enderror" id="role" name="role" placeholder="Role" value="{{ old('role', $user->role) }}" required>
						...
						<div class="col-md-6 mb-3">
							<div class="form-group">
								...
								<input class="form-control @error('contact_number') is-invalid @enderror" id="contact_number" name="contact_number" type="number" value="{{ old('contact_number', $user->contact_number) }}" required>
